...
<template>
  <div>
    <div
      class="fixed bottom-0 bg-[#141414] lg:min-h-screen lg:pt-9 py-2 lg:w-20 w-full lg:border-r-[0.1px] lg:border-t-0 border-t-[0.1px] border-gray-500 flex lg:flex-col lg:items-center lg:justify-normal justify-around lg:gap-16 z-[2000]"
    >
      <router-link to="/">
        <svg
      ...
      <svg
        ...
        stroke-width="1.5"
        stroke="white"
        class="w-8 h-8 hover:stroke-slate-400 hover:cursor-pointer"
