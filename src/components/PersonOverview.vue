...
onMounted(() => {
  ...
  getSocial(route.params.id)
})
</script>
<template>
  <div class="lg:container px-4 py-8 flex lg:flex-row flex-col lg:items-start items-center gap-12">
    <img
    ...
    <div class="flex flex-col gap-8 text-white">
      <div class="flex flex-col gap-4 lg:text-start text-center">
        <span class="text-2xl">{{ details.name }}</span>
        <p>{{ details.biography }}</p>
      </div>
      <!-- details -->
      <div class="flex flex-col gap-2">
        <div class="flex gap-2" v-if="details.known_for_department">
          <span class="w-36">Known For</span>
          <span>{{ details.known_for_department }}</span>
        </div>
        <div class="flex gap-2" v-if="details.birthday">
          <span class="w-36">Born</span>
        ...
        <div class="flex gap-2" v-if="details.place_of_birth">
      ...
      <!-- social media -->
      <div class="flex lg:justify-start justify-center gap-4 py-6">
        <a
